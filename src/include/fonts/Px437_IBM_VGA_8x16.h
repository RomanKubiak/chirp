const uint8_t Px437_IBM_VGA_8x168pt7bBitmaps[] PROGMEM = {
...
const GFXglyph Px437_IBM_VGA_8x168pt7bGlyphs[] PROGMEM = {
  {     0,   1,   1,   8,    0,    0 },   // 0x20 ' '
  {     1,   4,  10,   8,    2,   -9 },   // 0x21 '!'
  {     6,   6,   4,   8,    1,  -10 },   // 0x22 '"'
  {     9,   7,   9,   8,    0,   -8 },   // 0x23 '#'
...
const GFXfont Px437_IBM_VGA_8x168pt7b PROGMEM = {
  (uint8_t  *)Px437_IBM_VGA_8x168pt7bBitmaps,
  (GFXglyph *)Px437_IBM_VGA_8x168pt7bGlyphs,
  0x20, 0x7E, 16 };
